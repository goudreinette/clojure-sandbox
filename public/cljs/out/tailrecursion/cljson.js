...
var x__27720__auto__ = (((o == null))?null:o);
var m__27721__auto__ = (tailrecursion.cljson._encode[goog.typeOf(x__27720__auto__)]);
if(!((m__27721__auto__ == null))){
return m__27721__auto__.call(null,o);
} else {
var m__27721__auto____$1 = (tailrecursion.cljson._encode["_"]);
if(!((m__27721__auto____$1 == null))){
return m__27721__auto____$1.call(null,o);
} else {
...
var G__29130 = i__$1;
var G__29131 = cljs.core.rest.call(null,c);
i = G__29130;
c = G__29131;
continue;
} else {
...
var temp__6753__auto__ = cljs.core.second.call(null,cljs.core.re_matches.call(null,/#([^<].*)/,cljs.core.pr_str.call(null,x)));
...
var temp__6751__auto__ = (function (){var and__26990__auto__ = cljs.core._STAR_print_meta_STAR_;
...
var or__27002__auto__ = tailrecursion.cljson.interpret.call(null,x);
if(cljs.core.truth_(or__27002__auto__)){
return or__27002__auto__;
} else {
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No cljson encoding for type '"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.type.call(null,x)),cljs.core.str.cljs$core$IFn$_invoke$arity$1("'.")].join('')));
}
...
var G__29141 = (i + (1));
var G__29142 = len;
var G__29143 = cljs.core.conj_BANG_.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])));
i = G__29141;
len = G__29142;
out = G__29143;
continue;
...
var G__29144 = (i + (2));
var G__29145 = len;
var G__29146 = cljs.core.assoc_BANG_.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])),tailrecursion.cljson.decode.call(null,(o[(i + (1))])));
i = G__29144;
len = G__29145;
out = G__29146;
continue;
...
if((i > (0))){
var G__29147 = (i - (1));
var G__29148 = cljs.core.conj.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])));
i = G__29147;
out = G__29148;
continue;
} else {
...
var G__29149 = (i + (1));
var G__29150 = len;
var G__29151 = cljs.core.conj_BANG_.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])));
i = G__29149;
len = G__29150;
out = G__29151;
continue;
...
break;
default:
var temp__6751__auto__ = (function (){var or__27002__auto__ = cljs.core.get.call(null,cljs.core.deref.call(null,cljs.reader._STAR_tag_table_STAR_),tag);
if(cljs.core.truth_(or__27002__auto__)){
return or__27002__auto__;
} else {
...
if(cljs.core.truth_(temp__6751__auto__)){
var reader = temp__6751__auto__;
return reader.call(null,tailrecursion.cljson.decode.call(null,(o[(1)])));
} else {
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No reader function for tag '"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag),cljs.core.str.cljs$core$IFn$_invoke$arity$1("'.")].join('')));
}
...
//# sourceMappingURL=cljson.js.map?rel=1491913249569