...
var m__27721__auto__ = (alandipert.storage_atom._get[goog.typeOf(x__27720__auto__)]);
if(!((m__27721__auto__ == null))){
return m__27721__auto__.call(null,this$,not_found);
} else {
var m__27721__auto____$1 = (alandipert.storage_atom._get["_"]);
if(!((m__27721__auto____$1 == null))){
return m__27721__auto____$1.call(null,this$,not_found);
} else {
...
var x__27720__auto__ = (((this$ == null))?null:this$);
var m__27721__auto__ = (alandipert.storage_atom._commit_BANG_[goog.typeOf(x__27720__auto__)]);
if(!((m__27721__auto__ == null))){
return m__27721__auto__.call(null,this$,value);
} else {
var m__27721__auto____$1 = (alandipert.storage_atom._commit_BANG_["_"]);
if(!((m__27721__auto____$1 == null))){
return m__27721__auto____$1.call(null,this$,value);
} else {
...
var self__ = this;
var this$__$1 = this;
var temp__6751__auto__ = self__.store.getItem(tailrecursion.cljson.clj__GT_cljson.call(null,self__.key));
...
alandipert.storage_atom.StorageBackend.cljs$lang$ctorPrWriter = (function (this__27659__auto__,writer__27660__auto__,opt__27661__auto__){
return cljs.core._write.call(null,writer__27660__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var G__29159 = atom;
cljs.core.add_watch.call(null,G__29159,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__29159,existing,debounce){
return (function (p1__29156_SHARP_,p2__29157_SHARP_,p3__29154_SHARP_,p4__29155_SHARP_){
if((alandipert.storage_atom._STAR_watch_active_STAR_) && (cljs.core.not_EQ_.call(null,p3__29154_SHARP_,p4__29155_SHARP_))){
return debounce.call(null,((function (G__29159,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__29155_SHARP_);
});})(G__29159,existing,debounce))
,(function (){var or__27002__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
var _STAR_watch_active_STAR_29162 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_29162;
}} else {
var temp__6753__auto__ = tailrecursion.cljson.cljson__GT_clj.call(null,e.key);
if(cljs.core.truth_(temp__6753__auto__)){
var sk = temp__6753__auto__;
if(cljs.core._EQ_.call(null,sk,k)){
var _STAR_watch_active_STAR_29163 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,(function (){var temp__6751__auto__ = e.newValue;
if(cljs.core.truth_(temp__6751__auto__)){
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_29163;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend.call(null,atom,storage,k,default$,p1__29164_SHARP_);
});})(default$))
);
});
/**
...
//# sourceMappingURL=storage_atom.js.map?rel=1491913249647